...
function drawBackground(ctx, W, H, t) {
  ...
  grad.addColorStop(0, '#040200'); grad.addColorStop(0.5, '#080400'); grad.addColorStop(1, '#040200');
  ctx.fillStyle = grad; ctx.fillRect(0, 0, W, H);
  const glow = ctx.createRadialGradient(W*0.5, H*0.38, 0, W*0.5, H*0.38, H*0.32);
  glow.addColorStop(0, 'rgba(240,180,60,0.14)'); glow.addColorStop(1, 'rgba(0,0,0,0)');
...
function drawTitle(ctx, W, H, data, t) {
  ...
  ctx.fillText(data.song?.title || 'Jazz Candle Table', W / 2, H * 0.40);
  ctx.restore();
}
...
const meta = { id: 'intro-050-jazz-candle-table', name: 'Jazz Candle Table', ratio: '9x16', accentColor: '#c8a03c' };
