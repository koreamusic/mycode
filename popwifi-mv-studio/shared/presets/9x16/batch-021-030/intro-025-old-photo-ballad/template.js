...
function drawBackground(ctx, W, H, t) {
  ...
  glow.addColorStop(0, 'rgba(180,140,80,0.10)'); glow.addColorStop(1, 'rgba(0,0,0,0)');
...
function drawTitle(ctx, W, H, data, t) {
  ...
  ctx.fillText(data.song?.title || 'Old Photo Ballad', W / 2, H * 0.40);
  ctx.restore();
}
...
const meta = { id: 'intro-025-old-photo-ballad', name: 'Old Photo Ballad', ratio: '9x16', accentColor: '#b48c50' };
