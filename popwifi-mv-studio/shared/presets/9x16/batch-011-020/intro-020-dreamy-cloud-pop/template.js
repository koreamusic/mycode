...
function drawBackground(ctx, W, H, t) {
  ...
  const bloom = ctx.createRadialGradient(W*0.30, H*0.20, 0, W*0.30, H*0.20, W*0.28);
...
function drawTitle(ctx, W, H, data, t) {
  ...
  ctx.fillText(data.song?.title || 'Dreamy Cloud Pop', W / 2, H * 0.40);
  ctx.restore();
}
...
const meta = { id: 'intro-020-dreamy-cloud-pop', name: 'Dreamy Cloud Pop', ratio: '9x16', accentColor: '#b4c8f0' };
